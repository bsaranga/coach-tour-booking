...
namespace coach_tour_booking_tests
{
    ...
    public class CustomerTests
    {
        ...
        private IAccountRepository SetUpAccountRepositoryMock()
        {
            ...
            accountRepositoryMock.Setup(a => a.CreateAccount(It.IsAny<CustomerRegistrationDto>())).Returns(new Customer("","","",DateTime.Today,"","",""));
        ...
        public void When_A_CustomerInfo_DTO_Is_Given_A_Customer_Account_Is_Created()
        {
            ...
            var customerInfo = new CustomerRegistrationDto(firstName, lastName, surName, dob, address, country, phone);
